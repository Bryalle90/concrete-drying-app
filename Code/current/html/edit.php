			...
			<div class="col-xs-offset-0 col-sm-offset-2 col-md-offset-2 col-lg-offset-3 col-xs-12 col-sm-8 col-md-8 col-lg-6 well well-lg">
				...
				<form class="form-horizontal" action="/edit.php" method="post">
					<div class="form-group row">
						...
						<div class="col-sm-10"><input type="text" class="form-control" name="tb_name" value="" placeholder="<?php echo $_SESSION['user']?>"></div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						<div class="col-xs-offset-0 col-sm-offset-2 col-xs-4">
